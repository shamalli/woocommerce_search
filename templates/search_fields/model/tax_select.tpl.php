<div class="wcsearch-search-model-input wcsearch-search-model-input-tax-select" <?php echo $search_model->getOptionsString(); ?>>
	...
	<?php if ($mode == "dropdown_address") wcsearch_print_suggestions_code($address_suggestions); ?>
	<?php if ($mode == "dropdown_keywords") wcsearch_print_suggestions_code($keywords_suggestions); ?>
</div>